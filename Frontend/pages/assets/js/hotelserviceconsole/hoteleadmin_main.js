...
//side link icons
const new_option_nav_icon = $('#new_option_nav_icon');
...
function openNewOptionContainer(){
    localStorage.setItem("guide_admin_console_current_state", "new_option");

    hideAllContainers();

    home_container.css('display','block');
    new_option_nav_icon.css('fill', '#00c4ff');
}
...
function saveNewHotelBtnClicked(){
    ...
    formData.append('option_1_description', $('#a_h_op1_description').val());
    formData.append('option_1_name', $('#a_h_op1_name').val());
    formData.append('option_1_fee', $('#a_h_op1_fee').val());
    formData.append('option_2_description', $('#a_h_op2_description').val());
    formData.append('option_2_name', $('#a_h_op2_name').val());
    formData.append('option_2_fee', $('#a_h_op2_fee').val());
    formData.append('option_3_description', $('#a_h_op3_description').val());
    formData.append('option_3_name', $('#a_h_op3_name').val());
    formData.append('option_3_fee', $('#a_h_op3_fee').val());
    formData.append('option_4_description', $('#a_h_op4_description').val());
    formData.append('option_4_name', $('#a_h_op4_name').val());
    formData.append('option_4_fee', $('#a_h_op4_fee').val());
