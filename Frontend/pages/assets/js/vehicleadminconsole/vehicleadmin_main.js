...
function loadAdminProfileData(){
    ...
    $.ajax({
        ...
        url: 'http://localhost:1010/main/vehicle-service/vehicle-admin-get-profile-data',
        async: true,
        data: {
...
//show loading model
    ...
    $.ajax({
        method: "POST",
        url: "http://localhost:1010/main/vehicle-service/vehicle-admin-update-profile-data",
        data: formData,
